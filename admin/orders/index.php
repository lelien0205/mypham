...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<!-- <div class="card-tools">
			<a href="?page=order/manage_order" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Tạo mới</a>
		</div> -->
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		...
		$('.pay_order').click(function(){
			_conf("Bạn có chắc chắn đánh dấu đơn đặt hàng này là đã thanh toán không?","trả_đặt hàng",[$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
