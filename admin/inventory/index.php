			...
			<div class="container-fluid">
				<table class="table table-hover table-striped table-bordered">
					...
					<tbody>
						<?php
						$i = 1;
						$qry = $conn->query("SELECT i.*,p.name as product,b.name as bname from `inventory` i inner join `products` p on p.id = i.product_id inner join brands b on p.brand_id = b.id order by p.name asc ");
