		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="name" class="control-label">Tên trang web</label>
				...
				<div class="form-group">
					<label for="" class="control-label">Bộ nhận diện thương hiệu</label>
				...
				<div class="form-group">
					<label for="" class="control-label">Trang bìa trang web</label>
					<div class="custom-file">
				...
				<div class="form-group">
					<label for="" class="control-label">Biểu ngữ</label>
					<div class="custom-file">
					...
					<small><i>Tải lên biểu ngữ mới</i></small>
				</div>
				<?php
