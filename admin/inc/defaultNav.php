      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
            <li><a href="#" class="dropdown-item">Các hành động </a></li>
            <li><a href="#" class="dropdown-item">Các hành động khác</a></li>
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 4 giờ trước
              </p>
              </div>
            </div>
            <!-- Message End -->
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Nhập tin nhắn ở đây</p>
                <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 4 giờ trước</p>
              </div>
            </div>
            <!-- Message End -->
