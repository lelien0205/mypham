        ...
        <div id="printable">
            <div class="row row-cols-2 justify-content-center align-items-center" id="print_header" style="display:none">
                ...
                <div class="col-7">
                    ...
                    <p class="text-center m-0">Thời gian <?php echo date("M d,Y", strtotime($date_start)) ?> - <?php echo date("M d,Y", strtotime($date_end)) ?></p>
                    <?php else: ?>
                    <p class="text-center m-0">Kể từ ngày <?php echo date("M d,Y", strtotime($date_start)) ?></p>
                    <?php endif; ?>
                </div>
            </div>
            <hr>
