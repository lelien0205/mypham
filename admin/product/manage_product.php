...
<div class="card card-outline card-info">
    ...
    <div class="card-body">
        <form action="" id="product-form">
            ...
            <div class="form-group">
                <label for="specs" class="control-label">Thông tin</label>
...
<script>
    ...
    function delete_img($path) {
        ...
        $.ajax({
            ...
            error: err => {
                console.log(err)
                alert_toast("Có lỗi xảy ra khi xóa ảnh", "error");
                end_loader()
            },
    ...
    $(document).ready(function() {
        $('.rem_img').click(function() {
            _conf("Bạn có chắc muốn xóa ảnh này vĩnh viễn?", 'delete_img', ["'" + $(this).attr('data-path') + "'"])
        })
