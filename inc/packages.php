<section class="page-section bg-dark" id="home">
	<div class="container">
				...
				<div class="card w-100 rounded-0">
					...
					<div class="card-body">
						...
						<div class="w-100 d-flex justify-content-end">
							<a href="./?page=packages&id=<?php echo md5($row['id']) ?>" class="btn btn-sm btn-flat btn-warning">Xem gói hàng<i class="fa fa-arrow-right"></i></a>
						</div>
					</div>
				</div>
			<?php endwhile; ?>
		...
		<div class="d-flex w-100 justify-content-end">
			<a href="./?page=packages" class="btn btn-flat btn-warning mr-4">Khám phá gói hàng<i class="fa fa-arrow-right"></i></a>
		</div>
	</div>
</section>