...
<footer class="py-4 bg-gradient-black" style="color: blue; background: yellow">
        ...
        <div class="row">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 col-md-4 col-xl-3" style="width: 22%">
                    <h4>Đỗ Quang Huân</h4>
                    <p>Mã sinh viên: 20103100580</p>
                    <p>Ngày sinh: 19/09/2001</p>
                    <p>Lớp: DHTI14A9HN</p>
                </div>
                <div class="col-md-4 col-sm-6 col-md-4 col-xl-3" style="width: 22%">
                    <h4>Lê Thị Phương Liên</h4>
                    <p>Mã sinh viên: 20103100545</p>
                    <p>Ngày sinh: 02/05/2001</p>
                    <p>Lớp: DHTI14A9HN</p>
                </div>
                <div class="col-md-4 col-sm-6 col-md-4 col-xl-3" style="width: 22%">
                    <h4>Nguyễn Thị Giang</h4>
                    <p>Mã sinh viên: 20103100566</p>
                    <p>Ngày sinh: 07/06/2002</p>
                    <p>Lớp: DHTI14A9HN</p>
                </div>
            </div>
        </div>
