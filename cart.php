    ...
    <div class="container">
        <div class="row">
            <div class="col d-flex justify-content-end mb-2">
                <button class="btn btn-outline-dark btn-flat btn-sm" type="button" id="empty_cart">Xóa toàn bộ sản phẩm</button>
            </div>
        </div>
        <div class="card rounded-0">
            <div class="card-body">
                <h3><b>Các sản phẩm trong giỏ hàng</b></h3>
...
<script>
    ...
    $(function() {
        ...
        $('#empty_cart').click(function() {
            // empty_cart()
            _conf("Bạn có chắc muốn xóa toàn bộ giỏ hàng?", 'empty_cart', [])
        })
        $('.rem_item').click(function() {
            _conf("Bạn có chắc chắn muốn xóa vật phẩm này khỏi giỏ hàng?", 'rem_item', [$(this).attr('data-id')])
        })
    })
</script>