    ...
    <div class="container px-4 px-lg-5 my-5">
        ...
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <div class="fs-5 mb-5">
                    <span id="price"><?php echo isset($inv[0]['price']) ?  $inv[0]['price'] : "--" ?>&#8363;</span>
                    <br>
                    <span><small><span class="text-muted">Số lượng trong kho:</span> <span id="avail"><?php echo isset($inv[0]['stock']) ? format_num($inv[0]['stock']) : "--" ?></span></small></span>
                    <h5>Loại</h5>
                    <?php
                    $active = false;
                    foreach ($inv as $k => $v) :
